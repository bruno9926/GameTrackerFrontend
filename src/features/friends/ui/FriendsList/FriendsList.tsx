...
const EmptyFriendsList = () => (
  <div className="flex flex-col justify-center items-center px-4 py-8 border-2 border-border border-dashed rounded-xl">
    ...
    <p className="font-medium text-subtitle text-sm text-center">No friends yet</p>
    <p className="mt-1 text-subtitle text-xxs">Add a friend using their code above</p>
  </div>
);
